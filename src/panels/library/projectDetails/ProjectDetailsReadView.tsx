...
export function ProjectFilesSection({ assets }: { assets: SpatialAsset[] }) {
...
type ProjectDetailsReadViewProps = {
  profile: DemoProjectDetailsProfile
  assets: SpatialAsset[]
}

export function ProjectDetailsReadView({ profile, assets }: ProjectDetailsReadViewProps) {
  return (
